...
): TheAsyncThing<TreeMap>;
export function toTree<T extends TreeMap>(
  node: unknown,
  options?: ToTreeOptions
): TheAsyncThing<T>;
export function toTree(
...
export function toTreeGenerator(
  node: unknown,
  options?: ToTreeOptions
): AsyncIterable<TreeMap>;
export function toTreeGenerator<M extends TreeMap>(
  node: unknown,
  options?: ToTreeOptions
): AsyncIterable<M>;
export async function* toTreeGenerator(
  node: unknown,
  options?: ToTreeOptions
): AsyncIterable<TreeMap> {
