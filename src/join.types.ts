...
> = T extends [Satisfies<infer F, string>, ...Satisfies<infer R, string[]>]
...
export type Join<
  ...
  Prefix extends string = "",
  Suffix extends string = ""
> = T2S<U2T<S>, Prefix, Suffix>;

export type JoinTupleString<
  S,
  Prefix extends string = "",
  Suffix extends string = ""
> = S extends []
  ...
  ? `${Prefix}${L & string}${Suffix}${JoinTupleString<R, Prefix, Suffix>}`
  : "";
