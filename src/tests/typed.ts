/**
 * Typed JSX is very much possible
 *
 * But at what cost....
 *
 * ... I have found starting with unknown everywhere, and using
 * type guards to be an effective way of working with JSX nodes.
 *
 * I believe type guards are the more configurable way to read your
 * information
 */
